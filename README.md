...
Open [os.blackroad.io](https://os.blackroad.io) in any browser. No signup required. Click roadbook in the dock.

Or visit [roadbook.blackroad.io](https://roadbook.blackroad.io) directly.

## What It Does

roadbook is one of 17 products in BlackRoad OS, a browser-based operating system running on 5 Raspberry Pi 5 computers with Hailo-8 AI accelerators.

- **    4316 lines** of working code
